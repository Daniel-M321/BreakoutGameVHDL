...
HD_PWD='C:/Users/user/Documents/SOC2/Repo2/BreakoutGameVHDL/xilinxprj/game.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gameAndReg32x32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gameAndReg32x32.tcl
